...
const PRICING = {
  S500: {
    Web: { monthly: 18, yearlyDiscount: 17 },
    "Web+App": { monthly: 22, yearlyDiscount: 18 }
  },
  S1000: {
    Web: { monthly: 15, yearlyDiscount: 20 },
    "Web+App": { monthly: 20, yearlyDiscount: 25 }
  }
};


const getSlab = (strength) => {
  return strength <= 500 ? "S500" : "S1000";
};
...
  const slab = strength <= 500 ? "S500" : "S1000";
...
  const costPerStudent = monthlyRate * months;
  const totalBeforeDiscount = costPerStudent * strength;
...
  if (billing === "Yearly") {
    discountPercent = pricing.yearlyDiscount;
...
              style={{ width: '100%', minHeight: '90px', padding: '10px', border: '1px solid #ddd', borderRadius: '6px' }}
            />
